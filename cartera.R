...
cvx.ba <- data.frame(
  ...
  Fecha.Cotización = c("6/5/2024","6/4/2024",
          ...
          Apertura = c(12900, 12785, 12659.5, 12100, 11900, 12319, 12513),
            Maximo = c(13140, 13050, 13100, 12709, 12066, 12319, 12775.5),
            Minimo = c(12623.5, 12100, 12382.5, 12042, 11700, 11701.5, 12160),
...
intc.ba <- data.frame(
  ...
  Fecha.Cotización = c("6/5/2024","6/4/2024",
          ...
          Apertura = c(7960, 7860, 7650, 7497, 7345, 7635, 7874.5),
            Maximo = c(8200, 8149.5, 7897.5, 7742, 7396.5, 7635, 7874.5),
            Minimo = c(7900, 7788, 7591, 7339, 7000, 7300, 7560),
